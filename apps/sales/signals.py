...
def update_commission_report(sender, instance, **kwargs):
    """
    Atualiza o relatório de comissão do vendedor após cada nova venda ou edição.
    """
    ...
    # Este passo é crucial, pois o relatório precisa existir para ser atualizado
    ...
    # 3. Recalcular o valor total de vendas para o período
    # Isso garante que a comissão será baseada em todos os dados mais recentes
