...
class DailySale(BaseModel):
    ...
    summary_description = models.CharField(
        max_length=255, 
        default="Total de vendas do dia",
        verbose_name="Descrição do Lançamento", 
        help_text="Uma descrição padronizada do total de vendas diário."
    )
    ...
    sale_type = models.CharField(max_length=10, choices=SaleType.choices, default=SaleType.IN_STORE,verbose_name="Tipo de Venda")
